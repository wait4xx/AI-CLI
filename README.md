...
<p align="center">
  <a href="https://github.com/wait4xx/AI-CLI-Mobile/actions"><img src="https://img.shields.io/github/actions/workflow/status/wait4xx/AI-CLI-Mobile/ci.yml?branch=main&style=flat-square&label=CI" alt="CI"></a>
  <a href="https://github.com/wait4xx/AI-CLI-Mobile/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue.svg?style=flat-square" alt="License"></a>
...
<p align="center">
  <a href="https://github.com/wait4xx/AI-CLI-Mobile/stargazers"><img src="https://img.shields.io/github/stars/wait4xx/AI-CLI-Mobile?style=flat-square&logo=github" alt="Stars"></a>
  <a href="https://github.com/wait4xx/AI-CLI-Mobile/network/members"><img src="https://img.shields.io/github/forks/wait4xx/AI-CLI-Mobile?style=flat-square&logo=github" alt="Forks"></a>
</p>
...
graph LR
    subgraph Client["📱 Client (Browser)"]
        direction TB
        XTerm["xterm.js<br/>WebGL Rendering"]
        React["React 18 SPA"]
        CM["CodeMirror 6"]
        Store["Zustand Store"]
        React --> XTerm
...
| Layer    | Technology                                                                               |
| -------- | ---------------------------------------------------------------------------------------- |
| Backend  | Node.js 20, Fastify 5, node-pty, tmux, zod                                               |
...
The service listens on the port configured by `PORT` in `.env` (default `18333`).
...
<a href="https://star-history.com/#wait4xx/AI-CLI-Mobile&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=wait4xx/AI-CLI-Mobile&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=wait4xx/AI-CLI-Mobile&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=wait4xx/AI-CLI-Mobile&type=Date" />
 </picture>
</a>
